...
/**
  ...
  * the License.
  */
object Tutorial_05_PartialFunction extends App {
  ...
  println("\nStep 5: Lifting a PartialFunction that returns an Option")
  val unknownTasteResult = isTasty.lift("unknown taste")
  println(unknownTasteResult)
}
