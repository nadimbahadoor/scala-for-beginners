...
/**
  ...
  * the License.
  */
object Tutorial_21_Mutable_ListBuffer extends App {

  import scala.collection.mutable.ListBuffer
  println("Step 1: How to initialize a ListBuffer with 3 elements")
  val listBuffer1 = ListBuffer("Plain Donut","Strawberry Donut","Chocolate Donut")
  ...
  listBuffer1 ++= List("Glazed Donut", "Krispy creme")
  println(s"Elements of listBuffer1 = $listBuffer1")
  ...
  val emptyListBuffer = ListBuffer.empty[String]
