...
/**
  ...
  * the License.
  */
object Tutorial_04_Immutable_Map extends App {

  println("Step 1: How to initialize a Map with 3 elements")
  val map1 = Map(("PD", "Plain Donut"), ("SD", "Strawberry Donut"), ("CD", "Chocolate Donut"))
  println(s"Elements of map1 = $map1")



  println("\nStep 2: How to initialize Map using key -> value notation")
  val map2 = Map("VD" -> "Vanilla Donut", "GD" -> "Glazed Donut")
  ...
  val map3 = map1 + ("KD" -> "Krispy Kreme Donut")
