...
/**
  ...
  * the License.
  */
object Tutorial_19_Mutable_ArrayBuffer extends App {

  import scala.collection.mutable.ArrayBuffer
  println("Step 1: How to initialize an ArrayBuffer with 3 elements")
  val arrayBuffer1 = ArrayBuffer("Plain Donut","Strawberry Donut","Chocolate Donut")
  ...
  arrayBuffer1 ++= List("Glazed Donut", "Krispy creme")
  println(s"Elements of arrayBuffer1 = $arrayBuffer1")
  ...
  val emptyArrayBuffer = ArrayBuffer.empty[String]
