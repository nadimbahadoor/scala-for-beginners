...
/**
  ...
  *
  * Tutorial: Learn How To Create Traits With Type Parameters
  *
  ...
  * the License.
  */
object Tutorial_02_TraitWithTypeParameters extends App {
  ...
  val donutShoppingCart1  = new DonutShoppingCart[String]()
