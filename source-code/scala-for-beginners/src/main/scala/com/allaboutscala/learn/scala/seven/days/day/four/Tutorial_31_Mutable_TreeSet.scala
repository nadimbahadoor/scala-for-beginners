...
/**
  ...
  * the License.
  */
object Tutorial_31_Mutable_TreeSet extends App {
  ...
  treeSet1 ++= TreeSet("Vanilla Donut", "Glazed Donut")
  ...
  val treeSet2 = TreeSet("Vanilla Donut", "Glazed Donut", "Plain Donut")
  ...
  val treeSet3 = TreeSet("Plain Donut", "Strawberry Donut", "Chocolate Donut")(ReverseAlphabetOrdering)
