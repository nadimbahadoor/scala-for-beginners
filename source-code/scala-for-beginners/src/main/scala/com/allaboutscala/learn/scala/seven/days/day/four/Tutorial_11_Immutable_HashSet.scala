...
/**
  ...
  * the License.
  */
object Tutorial_11_Immutable_HashSet extends App {

  import scala.collection.immutable.HashSet
  println("Step 1: How to initialize a HashSet with 3 elements")
  val hashSet1 = HashSet("Plain Donut","Strawberry Donut","Chocolate Donut")
  ...
  val hashSet2 = hashSet1 + "Vanilla Donut" + "Vanilla Donut"
  ...
  val emptyHashSet = HashSet.empty[String]
