...
/**
  ...
  * the License.
  */
object Tutorial_25_Mutable_LinkedHashMap extends App {

  import scala.collection.mutable.LinkedHashMap
  println("\nStep 1: How to initialize a LinkedHashMap with 3 elements")
  val linkedHashMap1 = LinkedHashMap("PD" -> "Plain Donut", "SD" ->"Strawberry Donut", "CD" -> "Chocolate Donut")
  println(s"Elements of linkedHashMap1 = $linkedHashMap1")



  println("\nStep 2: How to initialize a LinkedHashMap using key -> value notation")
  val linkedHashMap2 = LinkedHashMap("VD"-> "Vanilla Donut", "GD" -> "Glazed Donut")
  ...
  val emptyLinkedHashMap = LinkedHashMap.empty[String,String]
