...
/**
  ...
  * the License.
  */
object Tutorial_13_Immutable_SortedSet extends App {
  ...
  val sortedSet2 = sortedSet1 + "Vanilla Donut" + "Vanilla Donut"
  ...
  val sortedSet3 = sortedSet1 ++ SortedSet[String]("Vanilla Donut", "Glazed Donut")
  println(s"Add two SortedSets together using ++ = $sortedSet3")



  println("\nStep 5: How to remove element in SortedSet using -")
  val sortedSet4 = sortedSet1 - "Plain Donut"
  ...
  val sortedSet5 = SortedSet("Vanilla Donut", "Glazed Donut", "Plain Donut")
