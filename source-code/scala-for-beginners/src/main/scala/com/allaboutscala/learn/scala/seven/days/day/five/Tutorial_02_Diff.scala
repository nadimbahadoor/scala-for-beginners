...
object Tutorial_02_Diff extends App {
  ...
  val diffDonutBasket1From2 = donutBasket1 diff donutBasket2
  ...
  val diffDonutBasket2From1 = donutBasket2 diff donutBasket1
