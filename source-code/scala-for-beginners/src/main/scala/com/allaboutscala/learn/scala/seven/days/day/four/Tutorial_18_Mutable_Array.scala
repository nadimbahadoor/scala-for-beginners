...
/**
  ...
  * the License.
  */
object Tutorial_18_Mutable_Array extends App {

  println("Step 1: How to initialize a String Array with 3 elements")
  val array1 = Array("Plain Donut","Strawberry Donut","Chocolate Donut")
...
//  println(s"Elements of 2 dimensional array = ${array3.deep.toList}")
  ...
  val array4 = Array.ofDim[String](3,3)
//  println(s"Elements of 3 dimensional array = ${array4.deep.toList}")



  println("\nStep 6: How to create an Array using tabulate method")
  val array5 = Array.tabulate(5)(_ + 1)
  println(s"Array of 5 columns = ${array5.toList}")



  println("\nStep 7: How to create dimensional Arrays using tabulate method")
  val row1 = 1
  val column3 = 3
...
//  println(s"Array with 3 rows and 3 columns = ${arrayOfTowRowsAndThreeColumns.deep.toString}")
  ...
  val copyOfRangeArray = new Array[Int](rangeArray.size)
  ...
  val moreDonutsArray = Array("Vanilla Donut","Glazed Donut")
  val mergedDonutArray = Array.concat(array1, moreDonutsArray)
  println(s"Merged Array of donuts = ${mergedDonutArray.mkString(", ")}")



  println("\nStep 13: How to check if two Arrays are equal")
  val arrayToCompare = Array("Plain Donut","Strawberry Donut","Chocolate Donut")
  ...
  println("\nStep 14: How to check if two Arrays are equal using deep method and == ")
//  println(s"using deep method = ${array1.deep == arrayToCompare.deep}")
}
